...
<head>
  ...
  @yield('meta')
  <title>@yield('title') &mdash; MQAPP</title>
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
              ...
              <img alt="image" src="{{ URL::asset('images/avatar/avatar-1.png') }}" class="rounded-circle mr-1">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                @canany(['daftarulang lihat', 'daftarulang tambah', 'daftarulang edit', 'daftarulang hapus'])
                <li><a class="nav-link" href="/admin/santri/du">Daftar Ulang</a></li>
                @endcan
                @canany(['santri lihat', 'santri tambah', 'santri edit', 'santri hapus'])
                <li><a class="nav-link" href="/admin/santri">Data Santri</a></li>
                @endcan
                @canany(['sendiri lihat', 'sendiri tambah', 'sendiri edit'])
                <li><a class="nav-link" href="/santri/data_isi">Data Anda</a></li>
                @endcan
              </ul>
            </li>
            <li class="nav-item dropdown">
